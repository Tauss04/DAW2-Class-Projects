<?php
// NO ME ACUERDO QUE HACE ESTO PERO SI FUNCIONA NO LO TOQUES 
    ...
    <header>
        ...
        <div id="busqueda">
            <form action="buscar" method="post">
                ...
                <input id="cuadroBusqueda" name="busqueda" type="text" placeholder="Busca tu producto" minlenght="1" maxlength="45">
            </form>
        </div>
        <div id="filtrar">
    ...
    <section>
        <?php
            foreach($articulos as $articulo){
                ...
                if(isset($busqueda)){
                    if(strpos(strtolower($articulo['nombre']),strtolower($busqueda))!==false || strpos(strtolower($articulo['descripcion']),strtolower($busqueda))!==false){
                        $mostrarArticulo= true;
                    }else{
